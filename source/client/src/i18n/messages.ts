...
const messages = defineMessages({
  ...
  APP_DESCRIPTION: 'ドクターイエローに関するつぶやきから次の運行日を予測します。',
  APP_GITHUB_URL: 'https://github.com/karamem0/preddy',
  APP_LOADING: '読み込み中...',
  APP_NODATA: '表示するデータがありません。',
  APP_TITLE: 'ドクターイエロー運行予測',
  APP_TWITTER_URL: 'https://twitter.com/karamem0',
  APP_TWITTER_USERNAME: '@karamem0',
